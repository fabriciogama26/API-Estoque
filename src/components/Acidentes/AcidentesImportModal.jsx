...
export function AcidentesImportModal({
  open,
  onClose,
  onDownloadTemplate,
  onUploadFile,
      ...
      <div className="help-modal desligamento-help__modal" onClick={stopPropagation}>
        <header className="help-header">
          <div className="help-title">
            <p className="help-eyebrow">Acidentes em massa</p>
            <h3>Importar planilha XLSX</h3>
            <p className="help-summary">Importe uma planilha XLSX para registrar acidentes.</p>
          </div>
          <button type="button" className="help-close" onClick={onClose} aria-label="Fechar modal de importacao de acidentes">
        ...
        <div className="help-body desligamento-help__body">
          ...
          <section className="desligamento-help__card">
            ...
            <p className="desligamento-help__text">Campos opcionais: cat, cid, observacao.</p>
            <p className="desligamento-help__text">Agentes, tipos, lesoes e partes usam ";" como separador.</p>
          </section>
          ...
          <section className="desligamento-help__card">
            ...
            <div
              ...
              onClick={() => document.getElementById('acidentes-massa-file-input')?.click()}
            >
              <input
                id="acidentes-massa-file-input"
                type="file"
                accept=".xlsx"

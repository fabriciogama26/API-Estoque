export function MaterialBaseDiffModal({ open, details, onCancel, onConfirm }) {
  if (!open) {
    return null
  }
      ...
      <div className="modal__content" onClick={(event) => event.stopPropagation()}>
        ...
        <div className="modal__body">
          <p className="feedback feedback--warning">
            Ja existe material com mesmo grupo, item, fabricante, numeracao, cores e caracteristicas, mas com outro

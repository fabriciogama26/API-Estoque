...
export function EstoquePage() {
  ...
  const summaryCards = useMemo(
    () => [
      {
        ...
        tooltip: 'Saldo financeiro considerando apenas a quantidade disponivel (entradas - saidas) multiplicada pelo valor unitario.',
        icon: 'R$',
        accent: 'sky',
      },
      {
    ...
    [
      totalValorSaldo,
      resumoFiltrado.saldoQuantidade,

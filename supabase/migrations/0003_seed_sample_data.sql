...
values
  (uuid_generate_v4(), 'Capacete Classe B', '3M', 730, '12345', 89.90, 5, 'seed'),
  (uuid_generate_v4(), 'Luva Nitrilica', 'Ansell', 365, '67890', 24.50, 20, 'seed')
on conflict (id) do nothing;

insert into public.pessoas (id, nome, matricula, local, cargo, usuario_cadastro)
values
  (uuid_generate_v4(), 'Joao Silva', '0001', 'Manutencao', 'Tecnico', 'seed'),
  (uuid_generate_v4(), 'Maria Oliveira', '0002', 'Seguranca', 'Coordenadora', 'seed')
on conflict (id) do nothing;

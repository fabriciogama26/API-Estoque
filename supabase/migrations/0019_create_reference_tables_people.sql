-- Cria e popula tabelas de referência para centros de serviço, setores, cargos e centros de custo
-- a partir da tabela public.pessoas. Esta migração é incremental e segura para execuções repetidas.
...
create index if not exists tipo_execucao_ordem_idx
  on public.tipo_execucao (ativo desc, ordem asc, nome asc);

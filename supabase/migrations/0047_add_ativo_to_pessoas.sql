-- Adiciona coluna de status ativo em pessoas e ajusta views relacionadas.
...
-- Reconstrói objetos dependentes expondo a coluna ativo.
...
-- A view de indicadores utiliza o total de trabalhadores para IRA, ajusta para ignorar inativos.

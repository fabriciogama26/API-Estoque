...
import { runRelatorioEstoqueSemanalEmail, assertRelatorioSemanalEmailEnv } from "./_shared/relatorioEstoqueSemanalEmailCore.ts"
...
const SERVICE_NAME = "relatorio-estoque-semanal-email"
...
Deno.serve(async (req) => {
  ...
  try {
    ...
    const result = await runRelatorioEstoqueSemanalEmail({ testEmail, testOwnerId })
    const detalhes = {
      cron: !testEmail,

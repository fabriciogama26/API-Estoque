...
import { runRelatorioTrocaEpiEmail, assertRelatorioTrocaEmailEnv } from "./_shared/relatorioTrocaEpiEmailCore.ts"
...
const SERVICE_NAME = "relatorio-troca-epi-email"
...
Deno.serve(async (req) => {
  ...
  try {
    ...
    const result = await runRelatorioTrocaEpiEmail({ testEmail, testOwnerId })
    const detalhes = {
      cron: !testEmail,
